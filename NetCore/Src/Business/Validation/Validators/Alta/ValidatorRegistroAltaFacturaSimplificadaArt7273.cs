...
namespace VeriFactu.Business.Validation.Validators.Alta
{
    ...
    public class ValidatorRegistroAltaFacturaSimplificadaArt7273 : ValidatorRegistroAlta
    {
        ...
        public ValidatorRegistroAltaFacturaSimplificadaArt7273(Envelope envelope, RegistroAlta registroAlta, Settings settings) : base(envelope, registroAlta, settings)
        {
        }
