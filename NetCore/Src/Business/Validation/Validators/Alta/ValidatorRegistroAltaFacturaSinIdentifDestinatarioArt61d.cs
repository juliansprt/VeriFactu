...
namespace VeriFactu.Business.Validation.Validators.Alta
{
    ...
    public class ValidatorRegistroAltaFacturaSinIdentifDestinatarioArt61d : ValidatorRegistroAlta
    {
        ...
        public ValidatorRegistroAltaFacturaSinIdentifDestinatarioArt61d(Envelope envelope, RegistroAlta registroAlta, Settings settings) : base(envelope, registroAlta, settings)
        {
        }
