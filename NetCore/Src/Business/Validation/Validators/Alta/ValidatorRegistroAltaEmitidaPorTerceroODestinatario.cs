...
namespace VeriFactu.Business.Validation.Validators.Alta
{
    ...
    public class ValidatorRegistroAltaEmitidaPorTerceroODestinatario : ValidatorRegistroAlta
    {
        ...
        public ValidatorRegistroAltaEmitidaPorTerceroODestinatario(Envelope envelope, RegistroAlta registroAlta, Settings settings) : base(envelope, registroAlta, settings)
        {
        }
